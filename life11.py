...
class Controller(object):
    ...
    def __init__(self):
        ...
        self.pauseButton = Button(self.frame1, text='pause',command=self.playPauseGame)
        self.pauseButton.pack(side=LEFT)
        self.stepButton = Button(self.frame1, text='step',command=self.step)
        ...
        self.speedSlider = Scale(self.speedFrame, from_=1, to = 16,orient = HORIZONTAL,variable = self.speedVar)
...
# Set the pattern from the tuple and plot it
            ...
            if self.pattern.generation % int(self.nevery)==0:
                self.updateDisplay()
