...
# jflag indicates whether the pattern has at least one live cell in the left-most column (within the margin)
            ...
            reflected1tuple=tuple(sorted(reflected1))
            reflected2tuple=tuple(sorted(reflected2))
            reflected3tuple=tuple(sorted(reflected3))


# Only step pattern if it is not a reflection or translation to reference.

            if tuplej <= reflected1tuple and tuplej <= reflected2tuple and tuplej <=reflected3tuple and iflag and jflag:
